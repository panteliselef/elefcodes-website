      ...
      <div className="container">
        <Grid fluid>
          <Row>
            <Col xs={8} md={7}>
              <PageTitle
                text={["Read about the stuff", "doing"]}
                coloredText={"I am"}
              />
            </Col>
          </Row>
          ...
          <div style={{ maxWidth: "1200px", margin: "auto" }}>
            <Row between="xs" middle="xs">
              ...
              <Col xsOffset={0} xs={12} md={4} className="padding-1">
                ...
                >
                  I am a Web Developer and a CS student with a lot of experience
                  on creating awesome UIs and UXs
                </div>
              </Col>
            </Row>
          </div>
        ...
        <BurgerMenuButton
          ...
          opened={this.state.burgerMenuOpened}
        />
